...
- State: populated admin student directory, populated admin teacher-membership directory, and populated teacher student roster.
...
- [P1] Browser-rendered comparison is unavailable.
  Location: `/admin/students`, `/admin/teachers`, and `/teacher/students`.
...
- Capture all three authenticated routes at desktop width.
