    ...
    >
      <section className="flex w-full flex-col gap-4 sm:gap-5">
        ...
        {!loading && !error && !items.length ? (
          <EmptyState icon={Inbox} title="No notifications here yet" />
        ) : null}
        {!loading && !error && items.length ? (
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      {isUnread ? (
                        <Button
                          ...
                          variant="outline"
                          onClick={() =>
                            mutate(() => notificationService.markRead(item.id))
                          }
                        >
                      ...
                      <Button
                        ...
                        variant="outline"
                        onClick={() =>
                          mutate(() => notificationService.acknowledge(item.id))
                        }
                      >
                      ...
                      <Button
                        ...
                        variant="ghost"
                        onClick={() =>
                          mutate(() => notificationService.dismiss(item.id))
                        }
                      >
