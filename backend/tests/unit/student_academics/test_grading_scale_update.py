...
def test_update_grading_scale_rejects_invalid_effective_range() -> None:
    with pytest.raises(ValidationError, match="minimum score cannot exceed maximum score"):
        GradingScaleUpdate(min_score=Decimal("95"), max_score=Decimal("90"))
