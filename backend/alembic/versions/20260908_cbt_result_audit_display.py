...
Revision ID: 20260908_cbt_result_audit_display
...
revision: str = "20260908_cbt_result_audit_display"
...
def upgrade() -> None:
    ...
    # Existing ledger rows receive deterministic references derived from their
    # immutable Weave record UUID. New rows use the ORM generator.
    op.execute(
        sa.text(
            """
