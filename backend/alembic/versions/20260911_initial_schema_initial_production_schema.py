...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "institution_type",
            sa.Enum("PRIMARY_SCHOOL", "SECONDARY_SCHOOL", name="institution_type", schema="public"),
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "operation",
            sa.Enum("created", "updated", "deleted", name="cbt_sync_operation", schema="public"),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_cbt_sync_changes_created_at",
        "cbt_sync_changes",
        ["created_at"],
        unique=False,
        schema="public",
    ...
    op.create_table(
        ...
        postgresql.ExcludeConstraint(
            ...
            where=sa.text("start_date IS NOT NULL AND end_date IS NOT NULL"),
            using="gist",
            name="excl_academic_sessions_date_overlap",
        ),
        sa.CheckConstraint(
            "((status IN ('open', 'closing')) AND is_current = true) OR ((status IN ('draft', 'closed')) AND is_current = false)",
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("active", "suspended", "revoked", name="cbt_server_status", schema="public"),
            server_default="active",
            nullable=False,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["paired_by_admin_id"], ["public.tenant_admins.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["revoked_by_admin_id"], ["public.tenant_admins.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["tenant_id"],
            ["public.tenants.id"],
    ...
    op.create_index(
        ...
        "cbt_servers",
        ["tenant_id", sa.literal_column("lower(regexp_replace(btrim(name), '\\s+', ' ', 'g'))")],
        unique=True,
        schema="public",
    ...
    op.create_table(
        ...
        sa.Column(
            "owner_type",
            sa.Enum("tenant_admin", "teacher", name="comment_template_owner_type", schema="public"),
            nullable=False,
        ),
        ...
        sa.Column(
            "status",
            sa.Enum(
                "active", "inactive", "archived", name="comment_template_status", schema="public"
            ),
            server_default="active",
            nullable=False,
        ),
        ...
        sa.CheckConstraint(
            "(owner_type = 'tenant_admin' AND tenant_admin_id IS NOT NULL AND teacher_membership_id IS NULL) OR (owner_type = 'teacher' AND teacher_membership_id IS NOT NULL AND tenant_admin_id IS NULL)",
            name="ck_comment_templates_single_owner",
        ),
        sa.CheckConstraint(
            "is_default = false OR status = 'active'", name="ck_comment_templates_default_active"
        ),
        ...
        sa.ForeignKeyConstraint(
            ["tenant_admin_id"], ["public.tenant_admins.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["tenant_id"],
            ["public.tenants.id"],
    ...
    op.create_index(
        "ix_departments_tenant_archived",
        "departments",
        ["tenant_id", "archived_at"],
        unique=False,
        schema="public",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["used_by_server_id"], ["public.cbt_servers.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.Column(
            "terminal_completion_approved", sa.Boolean(), server_default="false", nullable=False
        ),
        sa.Column(
            "status",
            sa.Enum(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["credential_id"], ["public.cbt_server_credentials.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["tenant_id"],
            ["public.tenants.id"],
        ...
        sa.UniqueConstraint(
            "tenant_id", "ingestion_reference", name="uq_cbt_result_ingestion_tenant_reference"
        ),
        schema="public",
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["public.academic_level_departments.id"],
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["notice_id"], ["public.communication_notices.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["tenant_id"],
            ["public.tenants.id"],
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "teacher_comment_source <> 'admin_override' OR (teacher_comment_override_reason IS NOT NULL AND teacher_comment_override_admin_id IS NOT NULL AND teacher_comment_override_at IS NOT NULL)",
        ...
        sa.ForeignKeyConstraint(
            ["replaces_report_card_id"], ["public.report_cards.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(["student_id"], ["public.students.id"], ondelete="RESTRICT"),
        sa.ForeignKeyConstraint(
            ["teacher_comment_override_admin_id"], ["public.tenant_admins.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["tenant_id"],
            ["public.tenants.id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["ended_by_admin_id"], ["public.tenant_admins.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(["student_id"], ["public.students.id"], ondelete="RESTRICT"),
        sa.ForeignKeyConstraint(
            ["tenant_id"],
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "incoming_score >= 0", name="ck_cbt_result_ingestion_item_incoming_score_nonnegative"
        ),
        sa.CheckConstraint(
        ...
        sa.ForeignKeyConstraint(
            ["ingestion_batch_id"], ["public.cbt_result_ingestion_batches.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["tenant_id"],
            ["public.tenants.id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["tenant_id", "academic_level_department_id"],
            ["public.academic_level_departments.tenant_id", "public.academic_level_departments.id"],
            name="fk_curriculum_subject_department_tenant_level_department",
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["tenant_id", "curriculum_subject_id"],
            ["public.curriculum_subjects.tenant_id", "public.curriculum_subjects.id"],
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "draft", "submitted", "needs_review", name="teacher_comment_status", schema="public"
            ),
            server_default="draft",
            nullable=False,
        ),
        ...
        sa.CheckConstraint(
            "length(trim(comment_text)) > 0", name="ck_teacher_comment_text_nonempty"
        ),
        sa.ForeignKeyConstraint(
            ["academic_session_id"], ["public.academic_sessions.id"], ondelete="RESTRICT"
        ),
        ...
        sa.ForeignKeyConstraint(["class_id"], ["public.classes.id"], ondelete="RESTRICT"),
        sa.ForeignKeyConstraint(
            ["source_template_id"], ["public.comment_templates.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        postgresql.ExcludeConstraint(
            (sa.column("tenant_id"), "="),
            (sa.column("class_id"), "="),
            (sa.column("curriculum_subject_id"), "="),
        ...
        sa.ForeignKeyConstraint(["class_id"], ["public.classes.id"], ondelete="RESTRICT"),
        sa.ForeignKeyConstraint(
            ["curriculum_subject_id"], ["public.curriculum_subjects.id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["teacher_membership_id"], ["public.teacher_memberships.id"], ondelete="RESTRICT"
        ),
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "length(trim(comment_text)) > 0", name="ck_teacher_override_text_nonempty"
        ),
    ...
    op.create_index(
        ...
        "teacher_comment_overrides",
        ["tenant_id", "student_id", "academic_session_id", "academic_term_id", "created_at"],
        unique=False,
        schema="public",
    )
    op.create_table(
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_teacher_comment_overrides_student_period",
        table_name="teacher_comment_overrides",
        schema="public",
    )
    ...
    op.drop_index(
        "ix_teacher_comments_teacher_period",
        table_name="student_term_teacher_comments",
        schema="public",
    )
    op.drop_index(
        "ix_teacher_comments_student_period",
    ...
    op.drop_index(
        "ix_teacher_comments_status", table_name="student_term_teacher_comments", schema="public"
    )
    ...
    op.drop_index(
        "ix_curriculum_subject_departments_tenant_subject",
        table_name="curriculum_subject_departments",
        schema="public",
    )
    op.drop_index(
        "ix_curriculum_subject_departments_tenant_level_department",
    ...
    op.drop_index(
        "ix_student_enrollments_tenant_level", table_name="student_enrollments", schema="public"
    )
    op.drop_index(
    ...
    op.drop_index(
        "ix_class_term_department_tenant_term",
        table_name="class_term_department_assignments",
        schema="public",
    )
    op.drop_index(
        "ix_class_term_department_tenant_level_department",
    ...
    op.drop_index(
        "ix_cbt_pairing_codes_tenant_expiry", table_name="cbt_pairing_codes", schema="public"
    )
    op.drop_index(
        "ix_cbt_pairing_codes_tenant_active",
    ...
    op.drop_index(
        "ix_academic_level_departments_tenant_level_active",
        table_name="academic_level_departments",
        schema="public",
    )
    op.drop_index(
        "ix_academic_level_departments_tenant_level",
    ...
    op.drop_index(
        "ix_comment_templates_tenant_status", table_name="comment_templates", schema="public"
    )
    op.drop_index(
        "ix_comment_templates_teacher_owner", table_name="comment_templates", schema="public"
    )
    op.drop_index(
        "ix_comment_templates_owner_range", table_name="comment_templates", schema="public"
    )
    op.drop_index(
        "ix_comment_templates_admin_owner", table_name="comment_templates", schema="public"
    )
    ...
    op.drop_index(
        "ix_academic_levels_tenant_category_position", table_name="academic_levels", schema="public"
    )
    op.drop_index(
    ...
    op.drop_index(
        "ix_comm_notices_tenant_status", table_name="communication_notices", schema="public"
    )
    ...
    op.drop_index(
        "ix_cbt_sync_changes_tenant_entity", table_name="cbt_sync_changes", schema="public"
    )
