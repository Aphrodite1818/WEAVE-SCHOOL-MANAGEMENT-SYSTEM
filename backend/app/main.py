...
from app.modules.student_academics.progression_router import (
    router as academic_progression_router,
)
...
def create_app() -> FastAPI:
    ...
    app.include_router(academic_progression_router, prefix="/api/v1")
