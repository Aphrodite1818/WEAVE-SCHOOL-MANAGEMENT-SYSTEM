...
from app.core.rate_limit.keys import (
    build_rate_limit_key,
    digest_key_part,
    normalize_identifier,
)
from app.core.rate_limit.redis_limiter import RedisFixedWindowRateLimiter
...
class AuthRateLimitService:
    ...
    async def _enforce_rules(
        ...
        *,
        ...
        """Check all buckets first, then consume all if currently allowed."""
    ...
    async def check_otp_request_allowed(
        ...
        *,
        ...
        """Apply OTP resend/request limits."""

        await cls._enforce_rules(
            cls._otp_request_rules(
                email=email,
                purpose=purpose,
